...
const Portfolio = () => {
  return (
    <div>
      ...
      <div className='grid w-full lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  border-2 rounded-lg mb-10 bg-info z-60'>
      <div className='card  bg-base-100 shadow-xl mx-auto xs:ml-2 mt-4 mb-6'>
        <div className='image overflow-hidden'>
        <img className='h-80 xs:w-[320px] rounded-[10px] ' src={img1} alt="" />
        </div>
      ...
      <div className='card bg-base-100 shadow-xl mx-auto xs:ml-2 mt-4 mb-6'>
        <img className='h-80 rounded-[10px] xs:w-[320px]' src={img2} alt="" />
      ...
      <div className='card bg-base-100 shadow-xl mx-auto xs:ml-2 mt-4 mb-6'>
        <img className='h-80 rounded-[10px] xs:w-[320px]' src={img3} alt="" />
