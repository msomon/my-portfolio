...
import img1 from '../../image/somon electronics2.jpg'
...
const Warehouse = () => {
  ...
  return (
    <div>
      ...
      <div className=' h-80vh lg:mx-auto card lg:w-[500px] md:w-[750px]  bg-base-100 shadow-xl p-10 mt-8 mb-10 order-last '>
       <img src={img1} alt="" />
      </div>

   <div className='lg:h-[660px] lg:mx-auto card lg:w-[500px] bg-base-100 shadow-xl p-10 mt-8 mb-10 gap-2 order-fast '>
